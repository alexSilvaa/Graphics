...
GLuint CompileShaders()
{
    ...
    AddShader(shaderProgramID, "C:/Users/Paula Silva/Graphics/Lab 1/Shaders/simpleVertexShader.txt", GL_VERTEX_SHADER);
    AddShader(shaderProgramID, "C:/Users/Paula Silva/Graphics/Lab 1/Shaders/simpleFragmentShader.txt", GL_FRAGMENT_SHADER);
...
void display(){
	...
	mat4 persp_proj = perspective(45.0, 400/(float)height, 0.1, 100.0);
	...
	mat4 persp_proj2 = perspective(45.0, (float)width/400, 0.1, 100.0);
	mat4 model2 = rotate_x_deg(identity_mat4(), 45);
	...
	// top-left
	mat4 lookatview = look_at(vec3(-30.0f, -30.0f, 30.0f), vec3(0.0f, 0.0f, 0.0f), vec3(0.0f, 0.1f, 0.0f));
	mat4 model3 = rotate_y_deg(identity_mat4(), 45);
	...
	mat4 ortho_proj = ortho(-1.0f, 1.0f, -1.0f, 1.0f, -50.0f, 50.0f);
	mat4 model4 = rotate_x_deg(identity_mat4(), 90);
	mat4 model5 = rotate_z_deg(model4, i);
