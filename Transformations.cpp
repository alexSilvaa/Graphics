...
void keyPress(unsigned char key, int x, int y) {
	...
	//MULTIPLE
	if (key == 'j') {
		rotations = glm::rotate(rotations, 0.75f, glm::vec3(0.f, 0.01f, 0.0f));
		translations[0][3] = translations[0][3] + 0.5f;
		scaling = glm::scale(scaling, glm::vec3(0.25f));
		rotations2 = glm::rotate(rotations, 0.5f, glm::vec3(0.01f, 0.0f, 0.0f));
		translations2[1][3] = translations[1][3] + 0.5f;
		scaling2 = glm::scale(scaling, glm::vec3(0.75f));
	}
	if (key == 'k') {
		translations[0][3] = translations[0][3] + -0.1f;
	}
	...
	if (key == 'u') {
		scaling = glm::scale(scaling, glm::vec3(2.0f));
	}

	if (key == 'v') {
		scaling2 = glm::scale(scaling, glm::vec3(2.0f));
	}
